...
class AES(object):
    ...
    def pad(data, block=16):
        # I choosed the block to be 16 as the document of the assignment say use 16 bit
    ...
    def aes_main(self, data, key, isInv):
        ...
        # Raise error on invalid mode
            ...
            raise AttributeError("\n\n\tSupported AES Mode of Operation are ['ecb']")
...
p_t = input("please input the plain text\n")

# Encrypt data with your key
cyphertext = aes.encryption(p_t, key)

# Decrypt data with the same key
plaintext = aes.decryption(cyphertext, key)
print("cipher text:",cyphertext.upper())
